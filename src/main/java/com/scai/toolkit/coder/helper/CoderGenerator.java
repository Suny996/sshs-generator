package com.scai.toolkit.coder.helper;

import com.scai.toolkit.coder.model.Coder;
import com.scai.toolkit.coder.model.Column;
import com.scai.core.constant.Global;
import com.scai.core.util.Configure;
import com.scai.core.util.ReflectHelper;
import com.scai.toolkit.util.Freemarker;
...
public class CoderGenerator {
    ...
    public static void processPackageName(Coder coder) {
        ...
        if (StringUtils.isEmpty(coder.getPackageName())) {
            coder.setPackageName(Configure.getProperty("coder.package.prefix", "com.scai") + "." + coder.getModelName()
                    + "." + subPackageName);
        }
    }
